...
module Cythonizing.Cythonizable (
  Cythonizable(..)
) where
...
cythonizeMaybe :: (Cythonizable c) =>
  ...
  State Context SrcSpan (Maybe (c (Maybe CythonType, SrcSpan)))
