...
type AnalysisState annot = ContextState AnalysisContext annot
...
copy :: AnalysisState annot AnalysisContext
copy = do
  ctx <- get
  return ctx

openScope :: AnalysisState annot AnalysisContext
openScope = do
  ctx <- get
...
openModule :: AnalysisState annot AnalysisContext
openModule = do
  ctx <- get
  return (ctx{
    inGlobalScope = True,
...
addVarType :: String -> Type -> AnalysisState annot ()
...
bindGlobalVars' :: annot -> AnalysisContext -> [String] ->
  AnalysisState annot AnalysisContext
...
bindGlobalVars :: annot -> [String] -> AnalysisState annot ()
...
bindNonLocalVars' :: annot -> AnalysisContext -> [String] ->
  AnalysisState annot AnalysisContext
...
bindNonLocalVars :: annot -> [String] -> AnalysisState annot ()
...
updateLocalBindings :: AnalysisContext -> AnalysisContext
...
merge :: Map.Map String Binding -> AnalysisContext -> AnalysisState annot ()
...
mergeCopy :: AnalysisContext -> AnalysisState annot (Map.Map String [Type])
...
mergeScope :: AnalysisContext -> AnalysisState annot (Map.Map String [Type])
...
mergeModule :: AnalysisContext -> AnalysisState annot (Map.Map String [Type])
